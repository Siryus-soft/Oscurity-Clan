...
/* AVVIO PARTICELLE */
createFreeParticles("particles-reclutamento", "#9f4aff");
createCornerParticles("particles-reclutamento", "#9f4aff", "top-left");
createCornerParticles("particles-reclutamento", "#9f4aff", "top-right");
createCornerParticles("particles-reclutamento", "#9f4aff", "bottom-left");
createCornerParticles("particles-reclutamento", "#9f4aff", "bottom-right");
